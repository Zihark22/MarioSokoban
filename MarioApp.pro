...
#Include librairie SDL_image
    LIBS += -L /usr/local/Cellar/sdl2_image/2.6.0/lib/libSDL2_image-2.0.0.dylib
    INCLUDEPATH += /usr/local/Cellar/sdl2_image/2.6.0/include/SDL2
#Include librairie SDL_mixer
    LIBS += -L /usr/local/Cellar/sdl2_mixer/2.6.0/lib/libSDL2_mixer-2.0.0.dylib
    INCLUDEPATH += /usr/local/Cellar/sdl2_mixer/2.6.0/include/SDL2
#Include librairie SDL_ttf
    LIBS += -L /usr/local/Cellar/sdl2_ttf/2.20.0/lib/libSDL2_ttf-2.0.0.dylib
    INCLUDEPATH += /usr/local/Cellar/sdl2_ttf/2.20.0/include/SDL2
